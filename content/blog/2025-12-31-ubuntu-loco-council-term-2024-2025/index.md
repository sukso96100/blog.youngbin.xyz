...
![](./ubuntu-circles-website.png)
> 우분투 커뮤니티 웹사이트에는 이미 리브랜딩이 반영이 되었다. 아무래도 오늘도 열심히 전세계 우분투 커뮤니티를 위해 힘쓰시는 서너명으로 구성된 캐노니컬 커뮤니티 팀 분들이 관리하시는 곳이기 때문일지도... 

## 임기를 마치며
이 외에도 LoCo Council 참여를 하면서 자잘하게 많은 활동을 하였다. 가끔씩 Discourse 에 카테고리 만들어 달라 하거나, Matrix 에 채팅방 생성 요청 처리 해 주는 것도 하고, UbuCon Asia나 Ubuntu Summit 참여 할 때는 가능하면 BoF 세션을 하나 운영하거나 부스 운영을 하며 Local Community와 LoCo Council 활동에 대해 소개하며 홍보를 하기도 하였다. 

돌아보면, 2년동안 한 활동 대부분은 과거에는 그 수가 정말 많고 활발했지만, 시간이 지나며 많은 수의 LoCo 운영진이 사라지고(어떤 이유로든), 그리고 최근 몇년 사이에는 LoCo가 점차 조금씩 다시 활성화 되는 시점에서, 어떻게 하면 활성화를 좀 더 빠르게 그리고 잘 할 수 있을지에 중점을 둔 것 같다. 그리고 새로운 새대의 운영진이 본인 지역의 LoCo 를 이끌어 볼까 고민 하거나, 시도를 해 보려는 경우도 많이 보였는데, 이런 사람들의 심리적인 진입 장벽도 낮춰서 LoCo를 작은 것에서부터 쉽게 시작할 수 있도록 하는데 중점을 두기도 하였다. 

라트비아 리가에서 열렸던 Ubuntu Summit 2023에 참석 했을 때, 로컬 커뮤니티에 대한 워크샵 세션(실습 세션이라기 보단 발표자가 몇가지 질문을 던지만 참가자가 답변도 하고 의논도 하고 하는 방식이였다.)에 참여를 하였는데, 그때가 아직도 기억이 난다. 해당 세션에는 이미 LoCo 를 큰 규모로 수년간 운영하던 팀, 이제 막 시작한 팀, 시작 해 볼까 고민하던 몇몇 개인도 있었다. 오랜 시간 LoCo 를 운영하던 지역의 운영진 분들이 본인들은 비영리 법인을 설립해서 LoCo 운영을 하고 있다고 사례를 공유하자, 옆에 있던 이제 막 LoCo 를 시작한 운영진 분들이나 아니면 시작할까 고민하던 분들이 "그러면 우리도 LoCo 시작하려면 일단 비영리 법인 먼저 설립해야 할 수 있는건가요?"라는 질문을 했던 것 같고, 이후에 꼭 그럴 필요는 없다는 답변으로 토론이 계속 이어졌던 것 같다. 재미있는 것은 이렇게 다른 배경의 사람들이 서로 고민거리 공유 해 보니 LoCo 에 대한 고민이 다 비슷했던 것 이였다.

![](./us-23-loco-workshop.jpg)
> Ubuntu Summit 2023 - 로컬 커뮤니티 워크샵 세션 당시 사진

꼭 이런것이 아니여도, 자기 지역에서 우분투 로컬 커뮤니티를 운영한다고 하면 사람들이 가지는 편견이나 기대가 다양하게 있다. 예를 들면, 우분투 LoCo 운영진이면 우분투의 커널부터 드라이버와 소프트웨어 패키징과 애플리케이션 에코시스템까지 전부 다 세세하게 꾀고 있을 것이라 생각하는 사람도 있고, 우분투 커뮤니티 운영진 한다고 하면 일단 "그럼 리눅스 커널 전문가시겠네요" 하는 사람도 있고, [Ubuntu Developer (우분투 배포판 개발 자체에 기여하고 직접적으로 영향을 주는 사람들)](https://documentation.ubuntu.com/project/who-makes-ubuntu/developers/dmb-index/)만 LoCo 운영진이 될 수 있다고 생각하는 사람도 있다. 우분투는 캐노니컬에서 기업에 공급 하기도 하니 그럼 캐노니컬 직원이냐고 물어보는 사람도 있다. 심지어는 우분투 LoCo 를 캐노니컬에 소속된 지사라고 생각하고 우분투 Pro 견적을 달라고 메일로 연락하는 사람도 간혹 있다. 꼭 우분투 LoCo 만의 이야기는 아니지만, 이전 세대의 운영진이 본인은 과거에 이만큼의 희생을 해서 커뮤니티를 일궈내었으니 다음 세대의 운영진도 본인만큼 희생해야 한다고 주장하는 경우도 있기도 하다. 

그러면 어떤 사람이 우분투 LoCo 운영진이 되어야 하는 걸까? 앞에 언급한 것을 다 따지기 시작하면 지역별 LoCo 를 운영하려고 참여 하는 사람은 아무도 없을 것이고, 하던 사람도 지쳐서 떠나갈 지도 모르겠다. 이건 마치 자전거 동호회 같은것을 운영 하려면 일단 자전거 설계하고 개발하는 20년 이상 경력의 엔지니어가 되어야 하고, 운영중인 자전거 동호회 운영에 참여하려면 심장마비 오기 직전까지 불철주야 일해서 희생하는것이 필수하고 하는 것이 아닌가 싶다. 내가 생각하는, 그리고 함께 해 왔던 LoCo Council 멤버 분들이나 뒤에서 이것저것 지원도 해 줬던 캐노니컬 커뮤니티 팀 분들이 생각하는 우분투 LoCo는, 일단 시작하기 쉽고 또 참여하기도 쉽고 재미있어야 한다가 아닐까 싶다. 본인의 지역에서 우분투 LoCo 를 시작하고 싶다면, 그냥 우분투라는 오픈소스 프로젝트에 관심이 있고 커뮤니티를 "지속적으로" 이끌어 나갈 열정만 있으면 곧 시작할 수 있어야 한다는 것이다. 커뮤니티 활동도 꼭 처음부터 큰 규모의 행사를 매년 치룰 필요도 없고, 작은 밋업 행사를 매주 혹은 매달 할 필요도 없고, 그렇게 해서 입소문으로 과거에 지역 우분투 커뮤니티에 참여 했었던 사람이나 과거 핵심 멤버 귀에까지 들어가서 만족하게 할 정도까지 갈 필요도 없다. 얼마나 자주 하든, 꾸준히 정기적으로 하고 몇명이라도 모여서 모임 가지고면서 꾸준히 해 나가는 것이 중요하다. 거기에 Ubuntu Discourse 에 모임 가졌다고 올려줘서 생존신고 자주 해 주면 더 좋다. 아무래도 그래야 LoCo Council 에서도 각 LoCo 가 열심히 하는지 알 수 있으니...(그냥 사진 한두장에 "오늘 모여서 이런거 했어요" 두세문장 정도로도 충분) 

아무튼 LoCo Council 활동을 하면서, 생각 해 보면 우분투 커뮤니티의 다른 활동(UbuCon Asia나 우분투한국커뮤니티 등)만큼 생각보다 많은것을 해내지는 못해서 아쉬운 것도 많이 있지만, 나름대로 굵직한(?) 성과도 있고 직접 지역 커뮤니티를 운영하는 입장이 아닌 이러한 지역 커뮤니티를 지원하고 가이드를 주는 입장에서 어떻게 해야 우분투 로컬 커뮤니티가 더 활발해지고 또 지속가능한 형태로 운영되도록 할 수 있을까에 대해서고 고민 해 볼 수 있었던 의미있는 활동이였다. 또 LoCo Council 선거에 출마 할지는 아직 잘 모르겠지만, 선출이 다시 되어 LoCo Council 활동을 하든 아니면 국내 우분투 커뮤니티나 다른 오픈소스 커뮤니티 활동을 하든, 어떻게 하면 지속 가능한 방법으로 활동을 할 수 있을지에 대해서는 앞으로도 계속 고민을 하면서 활동을 하게 될 것 같다.
